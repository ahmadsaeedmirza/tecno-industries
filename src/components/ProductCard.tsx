...
const ProductCard = ({ product }: { product: Product }) => (
  <Link to={`/product/${product.slug}`} className="group block">
    ...
    >
      ...
      <div className="p-4">
        <p className="text-[8px] uppercase tracking-[0.25em] text-primary mb-1">{product.category}</p>
        ...
        <div className="flex items-center justify-between">
          <span className="text-[10px] text-muted-foreground/60">{product.material}</span>
